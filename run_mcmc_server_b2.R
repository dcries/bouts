...
init = list(currentbetay=valsb[,1],
            ...
            currentSigmab=diag(2)*10, currentsigma2b=10,currentphi=2.89)
...
save(mcmc,file="boutsmcmc_b2.RData")
save(assessln,file="assessmcmc_b2.RData")