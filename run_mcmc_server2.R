...
init = list(currentbetay=c(2,-3,5,2,-2,3,-3,0,2),
            currentgamma=c(1,-2,3,0,-1,2,4,-2),currentsigma2y=0.95,currentsigma2x=6.73,
            ...
            propax2=1,propbx2=0.5,currentlambda=4.5,propl1=1,propl2=1,
            propd1=1,propd2=1,currentb=matrix(0,nrow=nrow(data$y1),ncol=2),btune=c(0.001,0.001),
            currentSigmab=diag(2)*.01, currentsigma2b=0.01,currentphi=5.89)
...
mcmc = mcmc_2part_nci7(data=data,init=init,priors=prior,nrep=300,burn=200)
