...
init = list(currentbetay=valsb[,2],
            currentgamma=valsg[,2],currentsigma2y=0.25,currentsigma2x=6.73,
            ...
            propax2=1,propbx2=0.5,currentlambda=.8,propl1=1,propl2=1,
            propd1=1,propd2=1,currentb=matrix(0,nrow=nrow(data$y1),ncol=2),btune=c(0.0001,0.0001),
            currentSigmab=diag(2)*3, currentsigma2b=1,currentphi=.89)
